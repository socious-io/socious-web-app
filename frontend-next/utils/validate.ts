...
import { rxEmail, rxEmailDoubleSpec, rxFirstLastName, rxHasNumber, rxNotMobileNumber } from './regex';
...
export const registerStep1Validate: yup.SchemaOf<RegisterFormStep1Type> = yup.object().shape({
    firstName: yup
        .string()
        .trim()
...
export const registerStep2Validate: yup.SchemaOf<RegisterFormStep2Type> = yup.object().shape({
    email: yup
        .string()
        .required('msg:txEmailRequired')
        .max(EMAIL_LENGTH, 'msg:txEmailMaxLength')
...
export const registerStep3Validate: yup.SchemaOf<RegisterFormStep3Type> = yup.object().shape({
    password: yup
        .string()
...
export const changePasswordValidate: yup.SchemaOf<FormChangePasswordType> = yup.object().shape({
    current_password: yup.string().required('changePassword:txCurrentPasswordRequired'),
    new_password: yup
        .string()
    ...
    confirm_new_password: yup
        ...
        .oneOf([undefined, '', yup.ref('new_password')], 'msg:txConfirmPasswordNotMatch'),
});

export const formSendEmailValidate: yup.SchemaOf<SendEmailType> = yup.object().shape({
    email: yup
        .string()
        .required('msg:txEmailRequired')
        .max(EMAIL_LENGTH, 'msg:txEmailMaxLength')
...
export const formResetPasswordValidate: yup.SchemaOf<FormResetPasswordType> = yup.object().shape({
    ...
    confirm_password: yup
        ...
        .oneOf([undefined, '', yup.ref('new_password_forgot')], 'msg:txConfirmNewPasswordNotMatch'),
});
...
export const schemaChangePassword = Joi.object({
    ...
    confirmNewPassword: Joi.string().min(8).valid(Joi.ref('newPassword ')).required().messages({
...
export const schemaOnboardingStep7 = Joi.object({
    ...
    phoneNumber: Joi.string().regex(rxNotMobileNumber).required().label('phoneNumber').messages({
        'any.required': `cannot be an empty field`,
