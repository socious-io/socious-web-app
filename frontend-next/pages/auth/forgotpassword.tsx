...
import { schemaForgotPasswordStep1, schemaForgotPasswordStep3 } from 'utils/validate';
        ...
        <div className="max-w-xl h-[45rem] m-auto  bg-background rounded-3xl py-7 px-6 border border-grayLineBased ">
            <div className="flex  justify-center  h-20 relative">
                <Modal isOpen={showModal} onClose={handleToggleModal}>
                    <Modal.Title>
                        <h2 className="text-error text-center">Sorry, something went wrong</h2>
                    </Modal.Title>
                    <Modal.Description>
                        <div className="mt-2">
            ...
            {(step === 2 || step === 4) && <ForgotPasswordStep2 onSubmit={handleSubmit} />}
