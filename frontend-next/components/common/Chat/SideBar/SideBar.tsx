...
const SideBar = ({chats, onChatOpen}: ChatSideBarProps) => {
  ...
  return (
    <div
      className="w-full h-screen min-w-80 sm:w-80 sm:border border-grayLineBased bg-background sm:h-[48rem] rounded-2xl relative"
      aria-label="Sidebar"
    >
      ...
      <div>
        ...
        {/* USER-CARD BOX */}
        {chats?.length !== 0 ? (
          <div className="overflow-y-auto sm:w-80 hide-scrollbar">
            {/* USER-CARD */}
          ...
          <div className="w-full sm:hidden flex items-center justify-center mb-10 h-[48rem] border border-grayLineBased bg-background sm:min-h-full rounded-2xl">
            {/* NO PARTICIPANT BOX */}
