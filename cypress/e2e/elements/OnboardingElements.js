class OnboardingElements {
  elements = {
    ...
    countryNullValMsg: () => cy.get('.location-form-country .text-error'),
    cityNullValMsg: () => cy.get('.location-form-city .text-error'),
    countryTxt: () => cy.get('input[name=country-input]'),
    cityTxt: () => cy.get('input[name=city-input'),
    selectedCountry: () => cy.get('.location-form-country .block'),
    selectedCity: () => cy.get('.location-form-city .block'),
